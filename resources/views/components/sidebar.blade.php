<div class="bg-[#50C878] w-[130px] h-[633px] rounded-tr-[12px] rounded-br-[12px]">
    ...
    <a href="/beranda"
        ...
        <div>
            <div class="bg-transparent w-[30px] h-[30px] ml-[18px] flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#fffff" viewBox="0 0 256 256">
                    <path
            ...
            <div class="bg-transparent w-[74px] h-[20px] mt-[-5px] ml-[-4px] flex items-center justify-center">Beranda
            </div>
        </div>
    </a>
    ...
    <a href="/transaksi"
        ...
        <div>
            ...
            <div class="bg-transparent w-[74px] h-[20px] mt-[-5px] ml-[-4px] flex items-center justify-center">Transaksi
            </div>
        </div>
    </a>
    ...
    <a href="/pelanggan"
        ...
        <div>
            ...
            <div class="bg-transparent w-[74px] h-[20px] mt-[-5px] ml-[-4px] flex items-center justify-center">Pelanggan
            </div>
        </div>
    </a>
    ...
    <a href="/produk"
        ...
        <div>
            ...
            <div class="bg-transparent w-[74px] h-[20px] mt-[-5px] ml-[-4px] flex items-center justify-center">Produk
            </div>
        </div>
    </a>
    ...
    <a href="/pengguna"
        ...
        <div>
            ...
            <div class="bg-transparent w-[74px] h-[20px] mt-[-5px] ml-[-4px] flex items-center justify-center">Pengguna
            </div>
        </div>
    </a>
    ...
    <a href="/rekap"
        ...
        <div>
            ...
            <div class="bg-transparent w-[74px] h-[20px] mt-[-5px] ml-[-4px] flex items-center justify-center">Rekap
            </div>
        </div>
    </a>
        ...
        <a href="javascript:void(0);" onclick="showModal()"
            ...
            <div>
                ...
                <div class="bg-transparent w-[74px] h-[20px] mt-[-5px] ml-[-4px] flex items-center justify-center">
                    Keluar</div>
            </div>
        </a>
    ...
    <div id="logoutModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white p-6 rounded-lg w-[300px] text-center">
            <p class="text-lg font-semibold">Apa Anda yakin ingin keluar?</p>
            <div class="mt-4 flex justify-around">
                <button onclick="logout()" class="bg-green-500 text-white font-semibold px-4 py-2 rounded-md">Ya</button>
                <button onclick="closeModal()" class="bg-red-500 text-white font-semibold px-4 py-2 rounded-md">Tidak</button>
            </div>
        </div>
    </div>
