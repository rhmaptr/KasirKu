    ...
    <div class="bg-slate-50 w-screen h-screen flex">
        ...
        <div class="bg-white w-[1217px] h-[390px] flex-col mt-[230px] ml-[-1217px] rounded-[15px] shadow-lg flex">
            ...
            <div class="bg-green-400 w-[1179px] h-[45px] mt-2 ml-4 rounded-[5px] shadow-lg flex">
                <p class="ml-[130px] mt-[10px] font-medium">No</p>
                <p class="ml-[185px] mt-[10px] font-medium">Nama</p>
                <p class="ml-[170px] mt-[10px] font-medium">Alamat</p>
                <p class="ml-[175px] mt-[10px] font-medium">No.Hp</p>
                <p class="ml-[200px] mt-[10px] font-medium">Aksi</p>
            </div>
